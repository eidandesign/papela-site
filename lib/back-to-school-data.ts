...
export const PAQUETES: Paquete[] = [
  {
    ...
    imagen: "/images/back-to-school/paquete-basico.webp",
    tint: "#F0D9CC",
    destacado: false,
    contenido: [
  ...
  },
  {
    ...
    imagen: "/images/back-to-school/paquete-bts.webp",
    tint: "#CED8D9",
    destacado: true,
    contenido: [
...
export const ACABADOS: Acabado[] = [
  { nombre: "Holográfico", texto: "Cambia de color con el reflejo de la luz.", precio: 80, imagen: "/images/back-to-school/acabado-holografico.webp" },
  { nombre: "Vinil contra agua", texto: "Resiste más al agua.", precio: 100, imagen: "/images/back-to-school/acabado-vinil.webp" },
  { nombre: "Acabados Arena", texto: "Agrega un poco de textura y brillo en el acabado.", precio: 200, imagen: "/images/back-to-school/acabado-arena.webp" },
  { nombre: "Estrellas", texto: "Estrellas holográficas que cambian con la luz.", precio: 80, imagen: "/images/back-to-school/acabado-estrellas.webp" },
  { nombre: "Corazón", texto: "Cambia de color con el reflejo de la luz.", precio: 80, imagen: "/images/back-to-school/acabado-corazon.webp" },
  { nombre: "Lluvia holográfica", texto: "Cambia de color con el reflejo de la luz.", precio: 80, imagen: "/images/back-to-school/acabado-lluvia.webp" },
];
